    ...
    <v-row justify="center">
      <v-col cols="10">
        ...
        <p>
          ...
          possibilidade do usuário colocar sua personalidade nos produtos ou
          apenas utilizar um dos nossos artigos exclusivos.
        </p>
        <p>
        ...
        <p>
          A sua privacidade é importante para nós. É política do POP YOU
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site POP YOU, e outros sites que possuímos e
          operamos.
        </p>
        <p>
        ...
        <h2>Política de Cookies POP YOU</h2>
        ...
        <ul>
          ...
          <li>
            ...
            apenas para usuários inscritos / não inscritos.<br /><br />
          </li>
          <li>
        ...
        <p>
          ...
          informação que o POP YOU oferece no site e com caráter enunciativo,
          mas não limitativo:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            xenofóbica, casas de apostas online, pornografia ilegal, de apologia
            ao terrorismo ou contra os direitos humanos;
          </li>
          <li>
            C) Não causar danos aos sistemas físicos (hardwares) e lógicos
            (softwares) do POP YOU, de seus fornecedores ou terceiros, para
